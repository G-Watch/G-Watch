...
CUresult cuLaunchHostFunc(
    ...
    if(capsule->is_capturing()){
        ...
        GW_CHECK_POINTER(cpu_event = new GWEvent("cuLaunchHostFunc"));
        ...
        GW_IF_FAILED(
            ...
            {
                GW_WARN(
                    "failed to push cpu event to capsule: api(cuLaunchHostFunc), err(%s)",
        ...
        GW_IF_FAILED(
            ...
            {
                GW_WARN(
                    "failed to push gpu event to capsule: api(cuLaunchHostFunc), err(%s)",
                    gw_retval_str(gw_retval)
                );
                delete gpu_event;
                gpu_event = nullptr;
