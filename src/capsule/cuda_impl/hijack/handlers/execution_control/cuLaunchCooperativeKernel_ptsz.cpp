...
CUresult cuLaunchCooperativeKernel_ptsz (
    ...
    if(capsule->is_capturing()){
        ...
        GW_CHECK_POINTER(cpu_event = new GWEvent("cuLaunchCooperativeKernel_ptsz"));
        ...
        GW_IF_FAILED(
            ...
            {
                GW_WARN(
                    "failed to push cpu event to capsule: api(cuLaunchKernel), err(%s)",
                    gw_retval_str(gw_retval)
                );
                delete cpu_event;
                cpu_event = nullptr;
        ...
        GW_IF_FAILED(
            ...
            {
                GW_WARN(
                    "failed to push gpu event to capsule: api(cuLaunchCooperativeKernel_ptsz), err(%s)",
                    gw_retval_str(gw_retval)
                );
                delete gpu_event;
                gpu_event = nullptr;
