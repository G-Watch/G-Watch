...
void gw_rt_control_start_app_trace(std::string name, uint64_t hash, std::string line_position){
...
void gw_rt_control_stop_app_trace(uint64_t begin_hash, uint64_t end_hash, std::string line_position){
    gw_retval_t retval = GW_SUCCESS;
    static bool is_hijacklib_loaded = __init_capsule();
